export class GridOperations {
  ...
  inputBox() {
    ...
    this.cellInput.style.top = this.selectedCell.yVal + this.mainGrid.mainCanvas.offsetTop + 'px';
    this.cellInput.style.left = this.selectedCell.xVal + this.mainGrid.mainCanvas.offsetLeft + 'px';
